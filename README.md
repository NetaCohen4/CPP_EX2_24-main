...
המחלקה Graph היא מחלקה המממשת גרף באמצעות מטריצת שכנויות, ויודעת לבצע אלגוריתמים בסיסיים על גרף כגון dfs, bfs ועוד.

פירוט האופרטורים ואופן התנהגותם:
*לפי הסדר בו האופרטורים מופיעים בקוד- בGraph.hpp, Graph.cpp
